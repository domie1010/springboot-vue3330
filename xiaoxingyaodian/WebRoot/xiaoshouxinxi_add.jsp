...
function gows()
{
	document.location.href="xiaoshouxinxi_add.jsp?id=<%=id%>&yaopinbianhao="+document.form1.yaopinbianhao.value;
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addXiaoshouxinxi.do" name="form1" method="post">
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var xiaoshoujiageobj = document.getElementById("xiaoshoujiage"); if(xiaoshoujiageobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(xiaoshoujiageobj.value)){document.getElementById("clabelxiaoshoujiage").innerHTML=""; }else{document.getElementById("clabelxiaoshoujiage").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}  
