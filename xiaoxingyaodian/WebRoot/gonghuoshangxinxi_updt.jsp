...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateGonghuoshangxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改供货商信息<input type="hidden" name="id" value="${gonghuoshangxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.gonghuoshang.value='${gonghuoshangxinxi.gonghuoshang}';</script>	<script language="javascript">document.form1.lianxishouji.value='${gonghuoshangxinxi.lianxishouji}';</script>	<script language="javascript">document.form1.dizhi.value='${gonghuoshangxinxi.dizhi}';</script>	
					 </table>
			</form>
   </body>
</html>
